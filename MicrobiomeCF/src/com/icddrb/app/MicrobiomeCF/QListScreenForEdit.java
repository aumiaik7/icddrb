package com.icddrb.app.MicrobiomeCF;
...
import com.icddrb.app.MicrobiomeCF.Search.SearchLayout;
import com.icddrb.app.MicrobiomeCF.Viewall.Viewall;
import com.icddrb.app.MicrobiomeCF.adapters.QlistAdapter;
...
public class QListScreenForEdit extends BaseActivity {
	...
	private void loadDataToList() {
		String sql = "";
		if (!CommonStaticClass.isMember)
			sql = "Select * from tblQuestion where SLNo<7";
