...
import com.icddrb.app.Electrocardiogram.BaseActivity;
import com.icddrb.app.Electrocardiogram.CommonStaticClass;
import com.icddrb.app.Electrocardiogram.Options;
import com.icddrb.app.Electrocardiogram.adapters.SpinAdapter;
import com.icddrb.app.Electrocardiogram.R;
				...
				try {
					...
					if (!(Integer.parseInt(NumChildren) > 2)) {
						...
						for (int i = 1; i <= Integer.parseInt(NumChildren); i++) {
							...
							if (dbHelper.executeDMLQuery(sqlsample)) {
