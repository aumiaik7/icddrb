package com.icddrb.app.wbspilloversub.questions;
...
public class PatientDetail extends BaseActivity {
	...
	public Boolean SavePatientDetail(
			com.icddrb.app.wbspilloversub.db.DatabaseHelper dbHelper, ViewGroup v) {
	...
	private boolean IsValidDischargeDate(ViewGroup vg,
			com.icddrb.app.wbspilloversub.db.DatabaseHelper dHelper) {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
	...
	public ArrayList<String> GetDistrict(
			com.icddrb.app.wbspilloversub.db.DatabaseHelper helper) {
		ArrayList<String> list = new ArrayList<String>();
		/*
		 * String sql = String
	...
	public ArrayList<String> GetUpazilla(
			com.icddrb.app.wbspilloversub.db.DatabaseHelper helper, String District) {
		ArrayList<String> list = new ArrayList<String>();
		list.add(" ");
		String sql = "";
	...
	public boolean IsValidMEMSCVB(com.icddrb.app.wbspilloversub.db.DatabaseHelper helper,
