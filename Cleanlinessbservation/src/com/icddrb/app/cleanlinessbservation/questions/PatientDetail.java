package com.icddrb.app.cleanlinessbservation.questions;
...
public class PatientDetail extends BaseActivity {
	...
	public Boolean SavePatientDetail(
			com.icddrb.app.cleanlinessbservation.db.DatabaseHelper dbHelper, ViewGroup v) {
	...
	private boolean IsValidDischargeDate(ViewGroup vg,
			com.icddrb.app.cleanlinessbservation.db.DatabaseHelper dHelper) {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
	...
	public ArrayList<String> GetDistrict(
			com.icddrb.app.cleanlinessbservation.db.DatabaseHelper helper) {
		ArrayList<String> list = new ArrayList<String>();
		/*
		 * String sql = String
	...
	public ArrayList<String> GetUpazilla(
			com.icddrb.app.cleanlinessbservation.db.DatabaseHelper helper, String District) {
		ArrayList<String> list = new ArrayList<String>();
		list.add(" ");
		String sql = "";
	...
	public boolean IsValidMEMSCVB(com.icddrb.app.cleanlinessbservation.db.DatabaseHelper helper,
