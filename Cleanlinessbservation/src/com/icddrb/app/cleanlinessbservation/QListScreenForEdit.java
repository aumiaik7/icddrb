...
import com.icddrb.app.cleanlinessbservation.Search.SearchLayout;
import com.icddrb.app.cleanlinessbservation.Viewall.Viewall;
import com.icddrb.app.cleanlinessbservation.adapters.QlistAdapter;
...
public class QListScreenForEdit extends BaseActivity {
	...
	private void loadDataToList() {
		String sql = "";
		if (!CommonStaticClass.isMember)
			sql = "Select SLNo,Qvar,Qdescbng,Qdesceng from tblQuestion  where (SLNo > 1 and SLNo < 43) order by SLNo asc";
		else
			sql = "Select SLNo,Qvar,Qdescbng,Qdesceng from tblQuestion where (SLNo > 1 and SLNo < 43)  order by SLNo asc";
