...
public class FileRead extends Activity {
	...
	public ArrayList<TransData> MakeInsertString(Context con,
			ArrayList<String> dblist, ArrayList<DatabaseID> databaseidList,
			Handler handler) {
		_DatabseList = databaseidList;
			...
			try {
				...
				if (mCursor.moveToFirst()) {
					do {
						...
						if (s.equalsIgnoreCase("parasites.sqlite")) {
							if (table_name.equalsIgnoreCase("precensusinfo")
									|| table_name.equalsIgnoreCase("tblC1Info")
									|| table_name
											.equalsIgnoreCase("tblCountIndexChild")
									|| table_name.equalsIgnoreCase("tblHHInfo")
									|| table_name
											.equalsIgnoreCase("tblNewBirthMigrationInfo")
									|| table_name
									...
									|| table_name
											.equalsIgnoreCase("tblTChildInfo")
									|| table_name
											.equalsIgnoreCase("tblUnder36Baseline")
						...
						else if (s.equalsIgnoreCase("Spilloversub.sqlite")) {
							if (table_name.equalsIgnoreCase("frmrtblChildInformation")
									|| table_name.equalsIgnoreCase("frmrtblHHCensus")
									|| table_name
											.equalsIgnoreCase("frmrtblMainQues")
									|| table_name.equalsIgnoreCase("frmrtblMainQuesSC")
									|| table_name
											.equalsIgnoreCase("frmrtblModule1")
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
											.equalsIgnoreCase("tblQuestion")
						...
						else if (s.equalsIgnoreCase("EEParasiteDworming.sqlite")) {
							if (table_name.equalsIgnoreCase("tblHHInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
											.equalsIgnoreCase("tblQuestion")
						...
						else if (s.equalsIgnoreCase("scform.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
									.equalsIgnoreCase("tblSingleArm")
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
											.equalsIgnoreCase("tblQuestion")
						...
						//--------------------------------------------------------------
						else if (s.equalsIgnoreCase("EEbloodsamplemother.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEffq.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEhairsamplemother.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEmirobiomeffq.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEoragenesaliva.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEoragenesalivafather.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEsalimetricssaliva.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEurinesamplemother.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (s.equalsIgnoreCase("EEvitalsigns.sqlite")) {
							if (table_name.equalsIgnoreCase("tblSamplesInfo")	
									|| table_name
											.equalsIgnoreCase("tblOptions")
									|| table_name
						...
						else if (table_name.equalsIgnoreCase("tblOptions")
								|| table_name.equalsIgnoreCase("tblQuestion")
								|| table_name.equalsIgnoreCase("tblstack")
								|| table_name.equalsIgnoreCase("tblDistrict")
								|| table_name.equalsIgnoreCase("tblUser")
								|| table_name
										.equalsIgnoreCase("tblParticipantInfo")
								|| table_name.equalsIgnoreCase("tblRandom")
								|| table_name.equalsIgnoreCase("tblUpazilla")
								|| table_name.equalsIgnoreCase("tblUpazila")
								|| table_name.equalsIgnoreCase("tblversion")
								|| table_name.equalsIgnoreCase("tblstack")
								|| table_name.equalsIgnoreCase("tblCluster")
								|| table_name.equalsIgnoreCase("tblhospital")
								|| table_name
										.equalsIgnoreCase("tblSamplesInfo")
								|| table_name.equalsIgnoreCase("DiagnosisCode")
								|| table_name.equalsIgnoreCase("District")
								|| table_name.equalsIgnoreCase("Division")
								|| table_name
										.equalsIgnoreCase("DrugChronicList")
								|| table_name.equalsIgnoreCase("DrugCode")
								|| table_name
										.equalsIgnoreCase("DrugCodeTreatment")
								|| table_name.equalsIgnoreCase("Hospital")
								|| table_name.equalsIgnoreCase("PoliceStation")
								|| table_name.equalsIgnoreCase("tblcensus")
								|| table_name
										.equalsIgnoreCase("tblcommunityInfo")
								|| table_name.equalsIgnoreCase("XRayCode")
								|| table_name.equalsIgnoreCase("tblOccupation")
								|| table_name.equalsIgnoreCase("tblUnion")
								|| table_name.equalsIgnoreCase("tblSetup")
								|| table_name
										.equalsIgnoreCase("tblOldMainQues")
								|| table_name.equalsIgnoreCase("tblrelation"))
							continue;

						_tran = new TransData();
						_tran.setDatabaseNm(GetDataBaseID(
								DatabaseHelper.DB_NAME, databaseidList));
