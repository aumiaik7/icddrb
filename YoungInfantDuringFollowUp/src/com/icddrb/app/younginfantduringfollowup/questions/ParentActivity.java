package com.icddrb.app.younginfantduringfollowup.questions;
...
import com.icddrb.app.younginfantduringfollowup.questions.ParentActivity;
import com.icddrb.app.younginfantduringfollowup.R;
import com.icddrb.app.younginfantduringfollowup.BaseActivity;
import com.icddrb.app.younginfantduringfollowup.CommonStaticClass;
import com.icddrb.app.younginfantduringfollowup.Options;
import com.icddrb.app.younginfantduringfollowup.adapters.SpinAdapter;
import com.icddrb.app.younginfantduringfollowup.db.DatabaseHelper;
...
public class ParentActivity extends BaseActivity implements FormListener {
	...
	private void loadGuiFrmDate(final ViewGroup v) {
		...
		if (!(pickDate.getText().toString().length() > 0)) {
			...
			String string = pickDate.getText().toString();
			String[] parts = string.split("-");
			dateDay = Integer.parseInt(parts[0]); // 004
			dateMonth = Integer.parseInt(parts[1]) - 1; // 034556
	...
	private void updateDisplay(String dt) {
		...
		if (dt.contains("date")) {
			...
			// Log.d("Date: ",date);
			if (qName.equalsIgnoreCase("Q6_signs_dt")) {
				{
			...
			if (qName.equalsIgnoreCase("q6") || qName.equalsIgnoreCase("Qf17b")) {
				{
	...
	private void FillAllDataidCombo(final ViewGroup v) {
		...
		adapterSl
				.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		((Spinner) v.findViewById(R.id.cobParticipant_list))
				.setAdapter(adapterSl);
		((Spinner) v.findViewById(R.id.cobParticipant_listRe))
				.setAdapter(adapterSl);
		...
		.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				((Spinner) vg.findViewById(R.id.sp4)).setSelection(0);
				((EditText) vg.findViewById(R.id.txtFllowUp)).setText("");
			}
		...
		((Spinner) v.findViewById(R.id.sp2))
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						((Spinner) vg.findViewById(R.id.sp4)).setSelection(0);
						((EditText) vg.findViewById(R.id.txtFllowUp)).setText("");
						if (CommonStaticClass.GetSpinnerValueFromString(
								((Spinner) vg.findViewById(R.id.sp2))).length() > 0) {

							((Spinner) vg.findViewById(R.id.sp3))
									.setSelection(((Spinner) vg
											.findViewById(R.id.sp2))
											.getSelectedItemPosition());
						}
					}
		...
		.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				((Spinner) vg.findViewById(R.id.spl4)).setSelection(0);
				((EditText) vg.findViewById(R.id.txtFllowUpRe)).setText("");
			}
		...
		((Spinner) v.findViewById(R.id.spl2))
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (CommonStaticClass.GetSpinnerValueFromString(
								((Spinner) vg.findViewById(R.id.spl2)))
								.length() > 0) {
							((Spinner) vg.findViewById(R.id.spl4)).setSelection(0);
							((EditText) vg.findViewById(R.id.txtFllowUpRe)).setText("");
							((Spinner) vg.findViewById(R.id.spl3))
									.setSelection(((Spinner) vg
											.findViewById(R.id.spl2))
											.getSelectedItemPosition());
						}
					}
		...
		((Spinner) v.findViewById(R.id.sp4))
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (CommonStaticClass.GetSpinnerValueFromString(
								((Spinner) vg.findViewById(R.id.sp4))).length() > 0) {

							String c = CommonStaticClass
									...
									+ CommonStaticClass
											.GetSpinnerValueFromString(((Spinner) v
													.findViewById(R.id.sp3)))
									+ CommonStaticClass
											.GetSpinnerValueFromString(((Spinner) v
													.findViewById(R.id.sp4)));

							String strSQL = "Select child_id from tblMainQues where  dataid like'"
									+ c + "%' order by participant_Code";
							// sql2 =
							// "Select * from tblOptions where QID like '" +
							// qvar + "%' order by SLNo ASC";
							...
							try {
								...
								mCursor = dbHelperBase
										.getQueryCursor_BASE(strSQL);
								if (mCursor.getCount() > 0) {
									...
									if (mCursor.moveToFirst()) {
										...
										((Spinner) v
												.findViewById(R.id.cobParticipant_list))
												.setAdapter(a);
		...
		((Spinner) v.findViewById(R.id.spl4))
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (CommonStaticClass.GetSpinnerValueFromString(
								((Spinner) vg.findViewById(R.id.spl4)))
								.length() > 0) {

							String c = CommonStaticClass
									.GetSpinnerValueFromString(((Spinner) v
											.findViewById(R.id.spl1)))
									+ CommonStaticClass
											.GetSpinnerValueFromString(((Spinner) v
													.findViewById(R.id.spl2)))
									+ CommonStaticClass
											.GetSpinnerValueFromString(((Spinner) v
													.findViewById(R.id.spl3)))
									+ CommonStaticClass
											.GetSpinnerValueFromString(((Spinner) v
													.findViewById(R.id.spl4)));
							...
							try {
								...
								if (mCursor.getCount() > 0) {
									...
									if (mCursor.moveToFirst()) {
										...
										ArrayAdapter b = new ArrayAdapter(
												thisactivity,
												android.R.layout.simple_spinner_dropdown_item,
												ids);
										b.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
										((Spinner) v
												.findViewById(R.id.cobParticipant_listRe))
												.setAdapter(b);
	...
	private boolean IsValidDataIDUserInput(ViewGroup v) {
		...
		if (((Spinner) v.findViewById(R.id.sp1)).getSelectedItem().toString()
				.trim().length() == 0) {
			return false;
		}
		if (((Spinner) v.findViewById(R.id.sp2)).getSelectedItem().toString()
				.trim().length() == 0) {
			return false;
		}
		if (((Spinner) v.findViewById(R.id.sp3)).getSelectedItem().toString()
				.trim().length() == 0) {
			return false;
		}
		if (((Spinner) v.findViewById(R.id.sp4)).getSelectedItem().toString()
				.trim().length() == 0) {
			return false;
		}
		if (((Spinner) v.findViewById(R.id.cobParticipant_list))
				.getSelectedItem().toString().trim().length() == 0) {
			return false;
		}
		String asd = ((EditText) v.findViewById(R.id.txtFllowUp)).getText()
				.toString();
		if (asd == null) {
			return false;
		}
		...
		CommonStaticClass.dataId = ((Spinner) v.findViewById(R.id.sp1))
				...
				+ ((EditText) v.findViewById(R.id.txtFllowUp)).getText()
						.toString();
		String ReDataid = ((Spinner) v.findViewById(R.id.spl1))
				...
				+ ((Spinner) v.findViewById(R.id.cobParticipant_listRe))
						.getSelectedItem().toString()
				+ ((EditText) v.findViewById(R.id.txtFllowUpRe)).getText()
						.toString();
	...
	private void updateTableDataFrmHHID(ViewGroup v) {
		...
		try {
			...
			if (((Spinner) v.findViewById(R.id.sp1)).getSelectedItem()
					.toString().trim().length() == 0) {
				return;
			}
			if (((Spinner) v.findViewById(R.id.sp2)).getSelectedItem()
					.toString().trim().length() == 0) {
				return;
			}
			if (((Spinner) v.findViewById(R.id.sp3)).getSelectedItem()
					.toString().trim().length() == 0) {
				return;
			}
			if (((Spinner) v.findViewById(R.id.sp4)).getSelectedItem()
					.toString().trim().length() == 0) {
				return;
			}
			if (((Spinner) v.findViewById(R.id.cobParticipant_list))
	...
	private boolean UpdateOtherField(ViewGroup v) {
		...
		String Pid = CommonStaticClass.GetSpinnerValueFromString((Spinner) v
				.findViewById(R.id.sp1))
		...
		try {
			...
			String strSQL = "Select Participant_nm from tblMainQues where  dataid ='"
					+ Pid + "'";
			c = dbHelperBase.getQueryCursor_BASE(strSQL);
			if (c.getCount() > 0)
				if (c.moveToFirst()) {
					do {
						name = c.getString(c.getColumnIndex("Participant_nm"));
					} while (c.moveToNext());
				}
			// name = (DR["Q_Participant_nm"].ToString());
			// DR.Close();
			// ConStrPV.Close();
		} catch (Exception ex) {
			ex.printStackTrace();
		...
		String strSQL = "update tblMainQues set participant_id = '"
				+ Pid
				+ "',Q_Participant_nm = '"
				+ name
				+ "', Q1_follow_up_seq = "
	...
	private void loadGuiFrmNumeric(final ViewGroup v) {
		...
		infoText.setText("");
		if (qName.equalsIgnoreCase("Q2_child_age")) {
			String sDate1 = "";
			String sDate2 = "";

			String sql = "Select Q_interview_dt,Q2_child_dob from tblMainQues where dataid='"
					+ CommonStaticClass.dataId + "'";
			Cursor mCursor1 = null;
			try {
				mCursor1 = dbHelper.getQueryCursor(sql);
				if (mCursor1.moveToFirst()) {
					do {
						sDate1 = mCursor1.getString(mCursor1
								.getColumnIndex("Q_interview_dt"));
						sDate2 = mCursor1.getString(mCursor1
								.getColumnIndex("Q2_child_dob"));
					} while (mCursor1.moveToNext());
				}
			} catch (Exception e) {
				// TODO: handle exception
			...
			if (CommonStaticClass.isNullOrEmpty(sDate1.trim())
					|| CommonStaticClass.isNullOrEmpty(sDate2.trim())) {
				return;
			}
			...
			if (ms1 > ms2)
				dif = ms1 - ms2;
			int diffInDays = 0;
			diffInDays = (int) (dif / (7 * 24 * 60 * 60 * 1000));
			infoText.setText(String.valueOf(diffInDays));
...
//							.equalsIgnoreCase("null"))) ? a : "");
					if (qName.equalsIgnoreCase("Q2_child_age")) {
						infoText.setText((a.length() > 0
								&& (!a.equalsIgnoreCase("-1")) && (!a
								.equalsIgnoreCase("null"))) ? a : infoText.getText());
					}
					

					else if (qName.equalsIgnoreCase("q8")) {
		...
		try {
			...
			if (code != -1) {
				...
				if (dbHelper.executeDMLQuery(sql)) {
					...
					if (CommonStaticClass.questionMap
							.get(CommonStaticClass.currentSLNo).getQvar()
							.equalsIgnoreCase("Q3_breast_fed")
							&& code == 1) {
						String updatesql = "UPDATE tblMainQues set Q4_fed_month = null where dataid='"
								+ CommonStaticClass.dataId + "'";
					...
					if (CommonStaticClass.questionMap
							.get(CommonStaticClass.currentSLNo).getQvar()
							.equalsIgnoreCase("Q5_symptoms")
							&& code == 2) {
						String updatesql = "UPDATE tblMainQues set Q7_seek_care = null,Q8_where_seek = null,Q9_day_illness = null,"
								+ "Q10_clt_specimen = null,Q11_specimen_dt = null where dataid='"
								+ CommonStaticClass.dataId + "'";
						if (dbHelper.executeDMLQuery(updatesql)) {
					...
					if (CommonStaticClass.questionMap
							.get(CommonStaticClass.currentSLNo).getQvar()
							.equalsIgnoreCase("Q7_seek_care")
							&& code == 2) {
						String updatesql = "UPDATE tblMainQues set Q8_where_seek = null where dataid='"
								+ CommonStaticClass.dataId + "'";
						if (dbHelper.executeDMLQuery(updatesql)) {
					...
					if (CommonStaticClass.questionMap
							.get(CommonStaticClass.currentSLNo).getQvar()
							.equalsIgnoreCase("Q10_clt_specimen")
							&& code == 2) {
						String updatesql = "UPDATE tblMainQues set Q11_specimen_dt = null where dataid='"
								+ CommonStaticClass.dataId + "'";
						if (dbHelper.executeDMLQuery(updatesql)) {
					...
					if (dbHelper.executeDMLQuery(sql)) {
						...
						if (CommonStaticClass.questionMap
								.get(CommonStaticClass.currentSLNo).getQvar()
								.equalsIgnoreCase("Q16_illness_seek_care")
								&& code == 2) {
							String updatesql = "UPDATE tblMainQues set Q17_where_seek_care = null,Q18_medications = null,Q18_medications_a = null,Q18_medications_b = null,Q18_medications_c = null, "
									+ "Q18_medications_d = null,Q18_medications_e = null,Q18_medications_otr = null where dataid='"
									+ CommonStaticClass.dataId + "'";
							if (dbHelper.executeDMLQuery(updatesql)) {
		...
		try {
			...
			if (mCursor1.moveToFirst()) {
				do {
					...
					String yearColumn = "years";/*
												 * CommonStaticClass.questionMap.
												 * get(
												 * CommonStaticClass.currentSLNo
												 * ).getQvar() + "years";
												 */
					String monthColumn = "months";/*
												 * CommonStaticClass.questionMap.
												 * get(
												 * CommonStaticClass.currentSLNo
												 * ).getQvar() + "months";
	...
	private void updateTableDataFrmYearToMin() {
		 ...
		 * 
		 * } else { CommonStaticClass.showMyAlert(con, "Message",
		 * "Year should be between 5 to 99"); yearBox.setText("");
		 * yearBox.requestFocus(); return; } }
		 * 
		 * }
		 */
	...
	private boolean gotoskip() {
		...
		if (qName.equalsIgnoreCase("Q18_medications")) {
			if (getSkip("Q18_medications_e", "tblMainQues").equalsIgnoreCase(
					"1")) {
		...
		if (qName.equalsIgnoreCase("Q11_medications")) {
			if (getSkip("Q11_medications_e", "tblMainQues").equalsIgnoreCase(
					"1")) {
				CommonStaticClass.findOutNextSLNo(CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar(),
						"Q11_medications_otr");
		...
		if (qName.equalsIgnoreCase("Q19_chronic_condition")) {
			if (getSkip("Q19_chronic_condition_d", "tblMainQues")
					.equalsIgnoreCase("1")) {
				CommonStaticClass.findOutNextSLNo(CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar(),
						"Q19_chronic_condition_otr");
				CommonStaticClass.nextQuestion(ParentActivity.this);
				return true;
			}
		...
		if (qName.equalsIgnoreCase("Q20")) {
			if (getSkip("Q20_f", "tblMainQues").equalsIgnoreCase("1")) {
				CommonStaticClass.findOutNextSLNo(CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar(),
						"Q20_f_otr");
				CommonStaticClass.nextQuestion(ParentActivity.this);
		...
		/*
		 * if (qName.equalsIgnoreCase("q6_2")) { String s =
		 * "SELECT * from tblMainQuesMc WHERE (q6_2_15 ='1' OR q6_2_16='1') AND dataid='"
		...
		/*
		 * if (qName.equalsIgnoreCase("q5_2")) { String s =
		 * "SELECT * from tblMainQuesMc WHERE (q5_2_1 ='1' OR q5_2_4='1') AND dataid='"
		 * + CommonStaticClass.dataId + "'"; if (dbHelper.IsDataExists(s)) {
		 ...
		 * 
		 * String s =
		 * "SELECT * from tblMainQuesMc WHERE (q54_6 ='1') AND dataid='" +
		 * CommonStaticClass.dataId + "'"; if (dbHelper.IsDataExists(s)) {
		 * CommonStaticClass.findOutNextSLNo(qName, "q55");
		 * CommonStaticClass.nextQuestion(ParentActivity.this); return true; }
		 * 
		 * s =
		 * "SELECT * from tblMainQuesMc WHERE (q54_1 ='1' OR q54_2 ='1' OR q54_3 ='1' OR q54_4 ='1' OR q54_5 ='1' OR q54_7 ='1') AND dataid='"
		 * + CommonStaticClass.dataId + "'"; if (dbHelper.IsDataExists(s)) {
