package com.icddrb.app.cleanlinessbservation;
...
import com.icddrb.app.cleanlinessbservation.adapters.SpinAdapter;
import com.icddrb.app.cleanlinessbservation.db.DatabaseHelper;
import com.icddrb.app.cleanlinessbservation.questions.ParentActivity;
import com.icddrb.app.cleanlinessbservation.R;

public class CommonStaticClass {

	public static String pName = "com.icddrb.app.cleanlinessbservation";
	...
	public static Options findOptionsForScvb(DatabaseHelper dbHelper,
		...
		if (qvar.equalsIgnoreCase("mq2_7")) {
			sql = "Select QID, CaptionEng, CaptionBang, Code, QNext from tblOptions WHERE (QID like'mq2_7%') order by SLNo";
		} else if (qvar.equalsIgnoreCase("mq2_9")) {
			sql = "Select QID, CaptionEng, CaptionBang, Code, QNext from tblOptions WHERE (QID like'mq2_9%') order by SLNo";
		} else if (qvar.equalsIgnoreCase("mq2_10")) {
			sql = "Select QID, CaptionEng, CaptionBang, Code, QNext from tblOptions WHERE (QID like'mq2_10%') order by SLNo";
		}
