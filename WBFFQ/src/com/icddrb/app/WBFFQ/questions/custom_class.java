...
public class custom_class extends BaseActivity {
	...
	public Boolean save(custom_class cust) {
		String sql = String
				.format("UPDATE tblMainQues SET c612_1= '%s', c612_2='%s', c612_3='%s', c612_4='%s', c612_5='%s', c612_6='%s', " +
						...
						+ "c612_1_other='%s', c612_3_other='%s', c612_4_other='%s', c612_6_other='%s' , c612_5_day='%s' WHERE dataid ='%s'",
						...
						cust.q612_6_other,  cust.q612_5_day, CommonStaticClass.dataId);
	...
	public custom_class GetRecords(DatabaseHelper dhelper) {
		...
		sql = "Select c612_1, c612_2, c612_3,c612_4,c612_6," +
				...
				"c612_1_other,c612_3_other,c612_4_other,c612_6_other, c612_5_day from "
			...
			if (mCursor1.getCount() > 0) {
				...
				if (mCursor1.moveToFirst()) {
					do 
					{
						...
						c.setQ612_5_day(mCursor1.getInt(mCursor1.getColumnIndex("c612_5_day"))==-1 ? -1 : mCursor1.getInt(mCursor1.getColumnIndex("c612_5_day")));
