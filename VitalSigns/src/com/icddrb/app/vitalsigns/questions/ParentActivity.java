...
import com.icddrb.app.vitalsigns.BaseActivity;
import com.icddrb.app.vitalsigns.CommonStaticClass;
import com.icddrb.app.vitalsigns.Options;
import com.icddrb.app.vitalsigns.R;
import com.icddrb.app.vitalsigns.adapters.SpinAdapter;
import com.icddrb.app.vitalsigns.db.DatabaseHelper;
...
//	}
	...
	private void updateTableDataFrmNumeric() {
		...
		if (qAns.length() > 0)
		{
		    ...
		    else if ( (qName.equalsIgnoreCase("q9")
		    			|| qName.equalsIgnoreCase("q10")
		    			|| qName.equalsIgnoreCase("q11")
		    			|| qName.equalsIgnoreCase("q25")
		    			|| qName.equalsIgnoreCase("q26")
		    			|| qName.equalsIgnoreCase("q28")
		    			|| qName.equalsIgnoreCase("q29")
		    			|| qName.equalsIgnoreCase("q31")
		    			|| qName.equalsIgnoreCase("q32"))  
						&& qAns.length() > 3) {
					
			    	CommonStaticClass.showMyAlert(con, "Alert",
								"Invalid Input Please give input within 3 digits");
						
					return;
							
			}
		    else if ( qName.equalsIgnoreCase("q17")
	    			|| qName.equalsIgnoreCase("q18")
	    			|| qName.equalsIgnoreCase("q19"))  
			{
		    ...
		    else if((qName.equalsIgnoreCase("q12")
		    		|| qName.equalsIgnoreCase("q34")) && qAns.length() !=1)
			{
		    	CommonStaticClass.showMyAlert(con, "Alert",
						"ID must be of 1 digit");
