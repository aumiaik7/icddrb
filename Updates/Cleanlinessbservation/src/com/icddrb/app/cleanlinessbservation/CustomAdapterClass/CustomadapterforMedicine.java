		...
		if (e.getQ2_12() != null) {
			if (e.getQ2_12().equalsIgnoreCase("0")) {
				txtans2_12
						.setText(String
								.valueOf(txtans2_12.getText().toString()
										+ "†MvcbxqZv eRvq ivLvi †Kvb e¨e¯’v wQj bv (cvqLvbvi Af¨šÍ‡ii RvqMvwU evB‡i †_‡K `„wó‡MvPi Kivi †Kvb e¨e¯’v wQj bv)"));
			} else if (e.getQ2_12().equalsIgnoreCase("1")) {
				txtans2_12
						.setText(String
								.valueOf(txtans2_12.getText().toString()
										+ "†MvcbxqZv eRvq ivLvi e¨e¯’vwU Kg cwigv‡b wQ‡jv/AvswkK wQj (`iRv wQj, wKšÍ– wQUwKwb wQj bv)"));
				...
				txtans2_12
						.setText(String
								.valueOf(txtans2_12.getText().toString()
										+ "†MvcbxqZv eRvq ivLvi e¨e¯’vwU AZ¨všÍ my`„p wQj (`iRvq wQUwKwb wQj Ges evB‡i †_‡K †evSv hvw”Q‡jv †h †fZ‡i GKRb e¨enviKvix Av‡Q)"));
