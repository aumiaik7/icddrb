package com.icddrb.app.urinesamplemother.questions;
...
import com.icddrb.app.urinesamplemother.BaseActivity;
import com.icddrb.app.urinesamplemother.CommonStaticClass;
import com.icddrb.app.urinesamplemother.Options;
import com.icddrb.app.urinesamplemother.R;
import com.icddrb.app.urinesamplemother.adapters.SpinAdapter;
import com.icddrb.app.urinesamplemother.db.DatabaseHelper;
...
//	}
	...
	private void updateTableDataFrmNumeric() {
		...
		if (qAns.length() > 0)
		{
		    if(qName.equalsIgnoreCase("q24") && qAns.length() !=4)
			{
...
//						}
//					}
					if(qName.equalsIgnoreCase("q11")  && code !=5 && getChoiceValue("q10") == 3)
					{
						CommonStaticClass.findOutNextSLNo(qName, "END");
						CommonStaticClass.nextQuestion(ParentActivity.this);
					}
	...
	private void updateTableDataFrmText() {
		...
		if (qAns.length() > 0) {
			...
			if (dbHelper.executeDMLQuery(sql)) {
				...
				else if(qName.equalsIgnoreCase("q11Other") && getChoiceValue("q10") == 3)
				{
					CommonStaticClass.findOutNextSLNo(qName, "END");
					CommonStaticClass.nextQuestion(ParentActivity.this);
				}
