package com.icddrb.app.toiletusers.questions;
...
import com.icddrb.app.toiletusers.BaseActivity;
import com.icddrb.app.toiletusers.CommonStaticClass;
...
public class PatientDetail extends BaseActivity {
	...
	public Boolean SavePatientDetail(
			com.icddrb.app.toiletusers.db.DatabaseHelper dbHelper, ViewGroup v) {
	...
	private boolean IsValidDischargeDate(ViewGroup vg,
			com.icddrb.app.toiletusers.db.DatabaseHelper dHelper) {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
	...
	public ArrayList<String> GetDistrict(
			com.icddrb.app.toiletusers.db.DatabaseHelper helper) {
		ArrayList<String> list = new ArrayList<String>();
		/*
		 * String sql = String
	...
	public ArrayList<String> GetUpazilla(
			com.icddrb.app.toiletusers.db.DatabaseHelper helper, String District) {
		ArrayList<String> list = new ArrayList<String>();
		list.add(" ");
		String sql = "";
	...
	public boolean IsValidMEMSCVB(com.icddrb.app.toiletusers.db.DatabaseHelper helper,
