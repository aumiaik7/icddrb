...
public class EditEntry extends BaseActivity {
		...
		listentries
				.setOnCreateContextMenuListener(new OnCreateContextMenuListener() {
					...
					public void onCreateContextMenu(ContextMenu menu, View v,
						...
						// TODO Auto-generated method stub
						// if(CommonStaticClass.userSpecificId.equalsIgnoreCase("3")||
						// CommonStaticClass.userSpecificId.equalsIgnoreCase("5")){
						menu.setHeaderTitle("Details of Record");
						menu.add(0, CONTEXTMENU_DELETE, 0,
								"Select to view this record?");
						// }
					}
				});
	}
	...
	public boolean onContextItemSelected(MenuItem aItem) {
		...
		case CONTEXTMENU_DELETE:
			...
			progressDialog = ProgressDialog.show(con, "Message", "Showing");

			try {

				String sql1 = "SELECT Name,AgeY,AgeM,AgeD,CASE Sex WHEN Sex=1 THEN 'Male' ELSE  'Female' END as Sex, EntryDate FROM tblMainQues WHERE dataid = '"
						+ dataid + "'";
				...
				try {
					...
					if (mCursor1.moveToFirst()) {
						do {
							String Name = "", AgeY = "", AgeM = "", AgeD = "", Sex = "", EntryDate = "";
							StringBuilder sb = new StringBuilder();

							Name = mCursor1.getString(mCursor1
									.getColumnIndex("Name"));
							sb.append("Name : ");
							sb.append(" " + Name + " ");
							AgeY = mCursor1.getString(mCursor1
									.getColumnIndex("AgeY"));
							sb.append(" " + AgeY + " ");
							sb.append("Y ");
							AgeM = mCursor1.getString(mCursor1
									.getColumnIndex("AgeM"));
							sb.append(" " + AgeM + " ");
							sb.append("M ");
							AgeD = mCursor1.getString(mCursor1
									.getColumnIndex("AgeD"));
							sb.append(" " + AgeD + " ");
							sb.append("D ");

							Sex = mCursor1.getString(mCursor1
									.getColumnIndex("Sex"));
							sb.append("Sex : ");
							sb.append(" " + Sex + " ");
							EntryDate = mCursor1.getString(mCursor1
									.getColumnIndex("EntryDate"));
							sb.append("EntryDate : ");
							sb.append(EntryDate);

							CommonStaticClass.showMyAlert(con, "Details",
									sb.toString());
	...
	private void loadDataToList() {
		String sql = "Select dataid from tblMainQues ORDER BY dataid";
