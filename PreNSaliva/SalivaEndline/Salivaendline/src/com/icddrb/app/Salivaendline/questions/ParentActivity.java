package com.icddrb.app.Salivaendline.questions;
...
import com.icddrb.app.Salivaendline.R;
import com.icddrb.app.Salivaendline.BaseActivity;
import com.icddrb.app.Salivaendline.CommonStaticClass;
import com.icddrb.app.Salivaendline.Options;
import com.icddrb.app.Salivaendline.adapters.SpinAdapter;
...
public class ParentActivity extends BaseActivity implements FormListener {
	...
	private ViewGroup frmdataid, frmchoiceone, frmcombobox, frmdate,
			...
			frmmultiplebangla, frmq124, frmmultiplechecknumeric, frmtimes, frmsamplegrid;
	...
	private void loadParentUI() {
		...
		frmtimes = (ViewGroup) findViewById(R.id.frmtimes);
		frmsamplegrid = (ViewGroup) findViewById(R.id.frmsamplegrid);
	...
	private void Load_UIFrmComboBox(final ViewGroup v) {
		...
		if (CommonStaticClass.questionMap.get(CommonStaticClass.currentSLNo)
				...
				|| CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar()
						.equalsIgnoreCase("q57")
						
						
						|| CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar()
						.equalsIgnoreCase("q55")
						
						|| CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar()
						.equalsIgnoreCase("q44")
						
						|| CommonStaticClass.questionMap
						.get(CommonStaticClass.currentSLNo).getQvar()
						.equalsIgnoreCase("q42")
					...
					do {
						...
						if (mCursor1.getColumnIndex(column.toLowerCase()) != -1) {
							...
							if (CommonStaticClass.questionMap
									...
									|| CommonStaticClass.questionMap
											.get(CommonStaticClass.currentSLNo)
											.getQvar().equalsIgnoreCase("q5")|| CommonStaticClass.questionMap
											.get(CommonStaticClass.currentSLNo).getQvar()
											.equalsIgnoreCase("q57")
	...
	private void updateDisplayfrmfamily(String dt) {
		...
		if (dt.contains("time")) {
			...
			if (qName != "" && qName.length() > 0) {
				if (qName.equalsIgnoreCase("q17hmd1")
						...
						// frmtimes part
						|| qName.equalsIgnoreCase("q17e_2d1")
						|| qName.equalsIgnoreCase("q17f_2d1")
						|| qName.equalsIgnoreCase("q17g_2d1")
						|| qName.equalsIgnoreCase("q19a_2d1")
						|| qName.equalsIgnoreCase("q19b_2d1")
						|| qName.equalsIgnoreCase("q19c_2d1")
						|| qName.equalsIgnoreCase("q17e_2d2")
						|| qName.equalsIgnoreCase("q17f_2d2")
						|| qName.equalsIgnoreCase("q17g_2d2")
						|| qName.equalsIgnoreCase("q19c_2d2")
						|| qName.equalsIgnoreCase("q19d_2d1")
						|| qName.equalsIgnoreCase("q19e_2d1")
						|| qName.equalsIgnoreCase("q19f_2d1")
	...
	// frmtimes part
	private void loadGuiFrmtimes(ViewGroup v) {
		// TODO Auto-generated method stub

		qName = CommonStaticClass.questionMap
				.get(CommonStaticClass.currentSLNo).getQvar();
		loadAllUiViewsFrmtimes(v);

		memberIDs = new ArrayList<String>();

		filllAllSpinnerDataFrmTimes();
	...
	private void filllAllSpinnerDataFrmTimes() {
		...
		spinnerSL.setAdapter(adapterSl);
		spinnerSL
				.setOnItemSelectedListener(new spinItemSelectListenerFrmTimes());

		checkDataBaseHasLinesOrNotFrmTimes();
	...
	private void checkDataBaseHasLinesOrNotFrmTimes() {

		String sql = String
				.format("Select * from '%s' where dataid = '%s' and Qname='%s' and memid='%s'",
						CommonStaticClass.questionMap.get(
								CommonStaticClass.currentSLNo).getTablename(),
						CommonStaticClass.dataId, CommonStaticClass.questionMap
								.get(CommonStaticClass.currentSLNo).getQvar(),
						CommonStaticClass.memberID);
	...
	class spinItemSelectListenerFrmTimes implements OnItemSelectedListener {
		...
		public void onItemSelected(AdapterView<?> parent, View arg1, int pos,
			...
			if (parent == spinnerSL) {
				if (parent.getItemAtPosition(pos).toString().length() > 0) {
					memberID = parent.getItemAtPosition(pos).toString();
					findDataForThisSelectionFrmTimes(memberID);
				}
			}

			/*
			 * else if (parent == spinnermedicine) { if
			 * (parent.getItemAtPosition(pos).toString().length() > 0) { sex =
			 * op.codeList.get(pos) + ""; if (sex.equalsIgnoreCase("30") ||
			 * sex.equalsIgnoreCase("31") || sex.equalsIgnoreCase("32") ||
			 * sex.equalsIgnoreCase("33")) { ((EditText)
			 * findViewById(R.id.etMedicineOther)) .setVisibility(View.VISIBLE);
			 * } else { ((EditText) findViewById(R.id.etMedicineOther))
			 * .setVisibility(View.GONE); } } }
			 */
	...
	private void updateTableDataFrmTimes() {
		// TODO Auto-generated method stub
		boolean proceed = true;
		if (!IsValidFrmTimes())
			return;
			...
			String s = String.format(
					"INSERT INTO '%s' (dataid, QName, Serial, qWhen, qWhenT1, qWhenT2, "
							+ "EntryBy, EntryDate, memid) VALUES "
							+ "('%s','%s','%s','%s','%s','%s','%s','%s','%s')",
					CommonStaticClass.questionMap.get(
							CommonStaticClass.currentSLNo).getTablename(),
					CommonStaticClass.dataId, CommonStaticClass.questionMap
							.get(CommonStaticClass.currentSLNo).getQvar(),
					memberIDs.get(spinnerSL.getSelectedItemPosition()), qWhen,
					qWhenT1, qWhenT2, CommonStaticClass.userSpecificId,
					entryDate, CommonStaticClass.memberID);
			...
			if (dbHelper.executeDMLQuery(s)) {
				...
				String sqlUp = String
						.format("UPDATE '%s' SET qWhen='%s', qWhenT1='%s', qWhenT2='%s', "
								+ " EditBy='%s', EditDate='%s' WHERE dataid='%s' "
								+ "AND QName='%s' AND Serial='%s' AND memid ='%s'",
								CommonStaticClass.questionMap.get(
										CommonStaticClass.currentSLNo)
										.getTablename(),
								qWhen,
			...
			if (memberIDs.contains((Integer.parseInt(memberID) + 1) + "")) {
				...
				insertMoreFrmTimes(false);
				CommonStaticClass.totalHHMember = Integer.parseInt(memberID);

			} else {
				new AlertDialog.Builder(con)
						.setTitle("Data updated")
						.setMessage("Do you want to insert more ?")
						.setPositiveButton("Yes",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
											int whichButton) {
										dialog.dismiss();
										insertMoreFrmTimes(true);
									}
								})
						.setNegativeButton("No",
								new DialogInterface.OnClickListener() {
	...
	public void findDataForThisSelectionFrmTimes(String memberid) {
		// TODO Auto-generated method stub
		/*
		 * String sql = "Select * from tblMedicineInfo where dataid = '" +
		 * CommonStaticClass.dataId + "' AND memid='" + memberID + "'";
		...
		String sql = String
				.format("Select * from '%s' where dataid = '%s' AND Serial='%s' AND QName='%s' AND memid = '%s'",
						CommonStaticClass.questionMap.get(
								CommonStaticClass.currentSLNo).getTablename(),
						CommonStaticClass.dataId,
						memberID,
	...
	private void doFillFrmTimes(Cursor mCursor1) {
		// TODO Auto-generated method stub
		if (mCursor1.moveToFirst()) {
			do {
				/*
				...
				((RadioGroup) MedicineLayout.findViewById(R.id.radiowhen))
						.clearCheck();
				((EditText) MedicineLayout.findViewById(R.id.ettime))
						.setText("");
				...
				switch (Integer.parseInt(when)) {
				case 1:
					((RadioButton) MedicineLayout.findViewById(R.id.radio0))
							.setChecked(true);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setVisibility(View.GONE);
					break;
				...
				case 2:
					((RadioButton) MedicineLayout.findViewById(R.id.radio1))
							.setChecked(true);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setVisibility(View.VISIBLE);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setText(mCursor1.getString(mCursor1
									.getColumnIndex("qWhenT1")));
					break;

				case 3:
					((RadioButton) MedicineLayout.findViewById(R.id.radio2))
							.setChecked(true);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setVisibility(View.VISIBLE);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setText(mCursor1.getString(mCursor1
									.getColumnIndex("qWhenT2")));
					break;

				case 99:
					((RadioButton) MedicineLayout.findViewById(R.id.radio3))
							.setChecked(true);
					((EditText) MedicineLayout.findViewById(R.id.ettime))
							.setVisibility(View.GONE);
					break;
	...
	private void resetViewsFrmTimes() {
		spinnerSL.setSelection(0);
		// spinnermedicine.setSelection(0);
		adapterSl.notifyDataSetChanged();
		spinnerSL.setSelection(memberIDs.size() - 1);

		((RadioGroup) MedicineLayout.findViewById(R.id.radiowhen)).clearCheck();
		((EditText) MedicineLayout.findViewById(R.id.ettime)).setText("");
	...
	private void insertMoreFrmTimes(boolean b) {
		// TODO Auto-generated method stub
		if (b) {
			...
			/*
			 * adapterSl.clear(); memberIDs.clear();
			 * adapterSl.notifyDataSetChanged();
			 */
			CommonStaticClass.findOutNextSLNo(
					CommonStaticClass.questionMap.get(
	...
	private boolean IsValidFrmTimes() {
		boolean IsValid = false;

		/*
		 * MedicineID =
		 * op.codeList.get(spinnermedicine.getSelectedItemPosition())
		 * .toString();
		 * 
		 * if (MedicineID.length() == 0) { CommonStaticClass.showMyAlert(con,
		 * "Error", "Please select Medicine."); return IsValid; }
		 */
		qWhenT1 = "";
		qWhenT2 = "";
		if (String.valueOf(qWhen).toString().length() <= 0) {
		...
		if (qWhen == 2) {
			qWhenT1 = ((EditText) MedicineLayout.findViewById(R.id.ettime))
					.getText().toString();
		}
		if (qWhen == 3) {
			qWhenT2 = ((EditText) MedicineLayout.findViewById(R.id.ettime))
					.getText().toString();
		}
	...
	private void Hidetimes(ViewGroup v) {
		((EditText) v.findViewById(R.id.ettime)).setVisibility(View.GONE);
	}
	...
	private void loadAllUiViewsFrmFamilyMember(ViewGroup v) {
		...
		MedicineLayout = (LinearLayout) v.findViewById(R.id.MedicineLayout);
		HideFamily(v);
	...
	private void loadAllUiViewsFrmtimes(ViewGroup v) {
		...
		MedicineLayout = (LinearLayout) v.findViewById(R.id.LinearLayout116);
		Hidetimes(v);
		...
		lblWhen = (TextView) v.findViewById(R.id.lblWhen);
		...
		if (CommonStaticClass.langBng) {
			if (CommonStaticClass.questionMap
				...
				Typeface font = Typeface.createFromAsset(getAssets(),
						"Siyam Rupali ANSI.ttf");
				lblWhen.setTypeface(font);
			}

			lblWhen.setText(CommonStaticClass.questionMap
					.get(CommonStaticClass.currentSLNo).getQdescbng().length() > 0 ? CommonStaticClass.questionMap
					.get(CommonStaticClass.currentSLNo).getQdescbng()
					: CommonStaticClass.questionMap.get(
							CommonStaticClass.currentSLNo).getQdesceng());
		} else {
			lblWhen.setTypeface(null);
			lblWhen.setText(CommonStaticClass.questionMap.get(
					CommonStaticClass.currentSLNo).getQdesceng());
		}

		lblSL = (TextView) v.findViewById(R.id.lblMemberID);

		radioGroupwhen = (RadioGroup) MedicineLayout
				.findViewById(R.id.radiowhen);
		...
		radioGroupwhen
				.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					...
					public void onCheckedChanged(RadioGroup arg0, int arg1) {
						...
						if (((RadioButton) radioGroupwhen
								.findViewById(R.id.radio0)).isChecked()) {
							qWhen = 1;
							((EditText) MedicineLayout
						...
						if (((RadioButton) radioGroupwhen
								.findViewById(R.id.radio3)).isChecked()) {
							qWhen = 99;
							((EditText) MedicineLayout
									.findViewById(R.id.ettime))
									.setVisibility(View.GONE);
		...
		/*
		 * radioGroupwhen.setOnCheckedChangeListener(new
		 * RadioGroup.OnCheckedChangeListener() {
		 * 
		 * public void onCheckedChanged(final RadioGroup group, int checkedId) {
		 * // TODO Auto-generated method stub
		 * 
		 * if (((RadioButton)findViewById(R.id.radio0)).isChecked()) { qWhen =
		 * 1; ((EditText) findViewById(R.id.ettime)) .setVisibility(View.GONE);
		 * 
		 * }
		 * 
		 * if (((RadioButton) findViewById(R.id.radio1)) .isChecked()) { qWhen =
		 * 2; ((EditText) findViewById(R.id.ettime))
		 * .setVisibility(View.VISIBLE); }
		 * 
		 * if (((RadioButton) findViewById(R.id.radio2)) .isChecked()) { qWhen =
		 * 3; ((EditText) findViewById(R.id.ettime))
		 * .setVisibility(View.VISIBLE); }
		 * 
		 * if (((RadioButton) findViewById(R.id.radio3)) .isChecked()) { qWhen =
		 * 99; ((EditText) findViewById(R.id.ettime)) .setVisibility(View.GONE);
		 * }
		 * 
		 * } });
		 */
	...
	private void loadGuiFrmHHID(ViewGroup v) {
		...
		v.findViewById(R.id.editText4).setOnTouchListener(
		...
		v.findViewById(R.id.editText4).setOnClickListener(
				new OnClickListener() {
		...
		v.findViewById(R.id.confButton).setOnClickListener(
				new OnClickListener() {
	...
	private boolean Save(ViewGroup viewGroup) {
		...
		String mid = null;
		String SampleColDate = null;
		String NumChildren = null;
		...
		clusterid = ((EditText) findViewById(R.id.editText2)).getText()
				.toString();
		...
		SampleColDate = ((EditText) findViewById(R.id.editText4)).getText()
				.toString();

		NumChildren = ((EditText) findViewById(R.id.editText5)).getText()
				.toString();
		CommonStaticClass.numberofchildren = Integer.parseInt(NumChildren);
					...
					if (!(Integer.parseInt(NumChildren) > 2)) {
						...
						if (dbHelper.executeDMLQuery(sql)) {
							...
							for (int i = 1; i <= Integer.parseInt(NumChildren); i++) {
								...
								String sample1 = dataid + "E" + i + "Z01";
								String sample2 = dataid + "E" + i + "Z02";
								String sample3 = dataid + "E" + i + "Z03";
								String sample4 = dataid + "E" + i + "Y01";
								String randomid1 = getRandomId(sample1);
								String randomid2 = getRandomId(sample2);
								String randomid3 = getRandomId(sample3);
								String randomid4 = getRandomId(sample4);
								
								String sqlsample = "Insert into sample (dataid,EntryBy,EntryDate, q67_1, q67_2,q67_3,q67_4, q68_1,q68_2,q68_3,q68_4, memid) values('"
										+ CommonStaticClass.dataId
										+ "','"
										+ CommonStaticClass.userSpecificId
										+ "','"
								...
								String sampleidday1 = dataid + "E" + i + "Y01";
								String sampleidday2 = dataid + "E" + i + "Z01";

								String randomidday1 = getRandomId(sampleidday1);

								String randomidday2 = getRandomId(sampleidday2);

								String sqlMc = "Insert into tblDay1 (dataid,EntryBy,EntryDate, sampleid, randomid, memberid) values('"
										+ CommonStaticClass.dataId
										+ "','"
										+ CommonStaticClass.userSpecificId
										+ "','"
								...
								String sqlSc = "Insert into tblDay2 (dataid,EntryBy,EntryDate, sampleid, randomid, memberid) values('"
										+ CommonStaticClass.dataId
										+ "','"
										+ CommonStaticClass.userSpecificId
										+ "','"
								...
								if (dbHelper.executeDMLQuery(sqlMc)
										&& dbHelper.executeDMLQuery(sqlSc) && dbHelper.executeDMLQuery(sqlsample)) {
	...
	private void updateTableDataFrmHHID() {
		...
		try {
			...
			if (cursor.getCount() != 0) {
				...
				// CommonStaticClass.sampleid =
				// CommonStaticClass.ClusterId+CommonStaticClass.MotherID+"M"+;
				sql = String
						.format("Insert into %s (dataid,EntryBy,EntryDate,AssetID,VersionNo, Clusterid, mid) VALUES('%s','%s','%s','%s','%s','%s','%s')",
								CommonStaticClass
										.GetTableName(CommonStaticClass.questionMap
												.get(CommonStaticClass.currentSLNo)
												.getQvar()),
				...
				sqlMc = "Insert into tblDay1 (dataid,EntryBy,EntryDate) values('"
						+ CommonStaticClass.dataId
						+ "','"
						+ CommonStaticClass.userSpecificId
						+ "','"
						+ entryDate
						+ "')";
				sqlSc = "Insert into tblDay2 (dataid,EntryBy,EntryDate) values('"
						+ CommonStaticClass.dataId
						+ "','"
						+ CommonStaticClass.userSpecificId
						+ "','"
				...
				if (dbHelper.executeDMLQuery(sql)
					...
					int hhidcheck;
					hhidcheck = Integer.parseInt(schoolid.subSequence(3, 5)
							.toString());
					if (hhidcheck >= 1 && hhidcheck <= 9) {
						CommonStaticClass.findOutNextSLNo(
								CommonStaticClass.questionMap.get(
										CommonStaticClass.currentSLNo)
										.getQvar(),
	...
	private void updateTableDataFrmMultipleCheckNumeric(ViewGroup v) {
		...
		if (checkIfSingleOptionIsCheckedFrmMultipleCheckCombo()) {
			...
			if (dbHelper.executeDMLQuery(sql)) {
				...
				if (qName.equalsIgnoreCase("q32C1")) {

					String v1 = dbHelper.GetSingleColumnData("q32C1_7");
				...
				if (qName.equalsIgnoreCase("q32C2")) {

					String v1 = dbHelper.GetSingleColumnData("q32C2_7");
				...
				if (qName.equalsIgnoreCase("q32C3")) {

					String v1 = dbHelper.GetSingleColumnData("q32C3_7");
				...
				if (qName.equalsIgnoreCase("qp10")) {

					String v1 = dbHelper.GetSingleColumnData("qp10_7");
				...
				if (qName.equalsIgnoreCase("qp14")) {

					String v1 = dbHelper.GetSingleColumnData("qp14_7");
				...
				if (qName.equalsIgnoreCase("q16")) {

					String v1 = dbHelper.GetSingleColumnData("q16_7");
				...
				if (qName.equalsIgnoreCase("q18")) {

					String v1 = dbHelper.GetSingleColumnData("q18_7");
				...
				if (qName.equalsIgnoreCase("q20")) {

					String v1 = dbHelper.GetSingleColumnData("q20_6");
				...
				if (qName.equalsIgnoreCase("q22")) {

					String v1 = dbHelper.GetSingleColumnData("q22_6");
				...
				if (qName.equalsIgnoreCase("q29")) {
					...
					String v1 = dbHelper.GetSingleColumnData("q29_12");
				...
				if (qName.equalsIgnoreCase("q37c1")) {
					...
					String v1 = dbHelper.GetSingleColumnData("q37c1_7");
				...
				if (qName.equalsIgnoreCase("q37c2")) {

					String v1 = dbHelper.GetSingleColumnData("q37c2_7");
				...
				if (qName.equalsIgnoreCase("q37c3")) {

					String v1 = dbHelper.GetSingleColumnData("q37c3_7");
				...
				if (qName.equalsIgnoreCase("q37c4")) {

					String v1 = dbHelper.GetSingleColumnData("q37c4_7");
				...
				if (qName.equalsIgnoreCase("q37c5")) {

					String v1 = dbHelper.GetSingleColumnData("q37c5_7");
				...
				if (qName.equalsIgnoreCase("q37c6")) {

					String v1 = dbHelper.GetSingleColumnData("q37c6_7");
				...
				if (qName.equalsIgnoreCase("q37c7")) {

					String v1 = dbHelper.GetSingleColumnData("q37c7_7");
				...
				if (qName.equalsIgnoreCase("q42c1")) {

					String v1 = dbHelper.GetSingleColumnData("q42c1_8");
				...
				if (qName.equalsIgnoreCase("q42c2")) {

					String v1 = dbHelper.GetSingleColumnData("q42c2_8");
				...
				if (qName.equalsIgnoreCase("q42c3")) {

					String v1 = dbHelper.GetSingleColumnData("q42c3_8");
				...
				if (qName.equalsIgnoreCase("q42c4")) {

					String v1 = dbHelper.GetSingleColumnData("q42c4_8");
				...
				if (qName.equalsIgnoreCase("q42c5")) {

					String v1 = dbHelper.GetSingleColumnData("q42c5_8");
				...
				if (qName.equalsIgnoreCase("q42c6")) {

					String v1 = dbHelper.GetSingleColumnData("q42c6_8");
				...
				if (qName.equalsIgnoreCase("q42c7")) {

					String v1 = dbHelper.GetSingleColumnData("q42c7_8");
				...
				if (qName.equalsIgnoreCase("q42c8")) {

					String v1 = dbHelper.GetSingleColumnData("q42c8_8");
	...
	private void checkEdboxHasDataFrmMultipleChoice(EditText edbox,
		...
		try {
			...
			boolean a = false;
			if (c.getCount() > 0) {
				a = doFill1FrmMultipleChoice(c, edbox, inColumn);
			}
				...
				if (code == -1) {
					...
					new Thread() {
						...
						public void run() {
							 ...
							 * !CommonStaticClass.dataId .substring(5,
							 * 7).equalsIgnoreCase( "00")) {
		...
		try {
			...
			if (code != -1) {
				...
				if (dbHelper.executeDMLQuery(sql)) {
					...
					/*
					 * if (qName.equalsIgnoreCase("q8day")) { if
					 * (CommonStaticClass.getSkip("q8day", "tblDay1",
					 * dbHelper).equalsIgnoreCase("1")) {
					 * 
					 * CommonStaticClass.findOutNextSLNo(qName, "q9day1");
					 * CommonStaticClass.nextQuestion(ParentActivity.this);
					 * return;
					 * 
					 * }
					 ...
					 * "SELECT q11d1 FROM tblDay1 WHERE length(q11d1)>0 AND q11d1 IS NOT NULL AND memberid ='%s' AND dataid = '%s'"
					 * , CommonStaticClass.memberID, CommonStaticClass.dataId)))
					 * {
					 * 
					 * CommonStaticClass.findOutNextSLNo(qName, "q9day2");
					 * CommonStaticClass.nextQuestion(ParentActivity.this);
					 * 
					 * 
					 * return; }
					 ...
					 * "Please enter data for day 1 first, then come back for day two."
					 * );
					 * 
					 * return;
					 * 
	...
	private void updateTableDataFrmSample(ViewGroup v) {
		// TODO Auto-generated method stub
		String q70_1,q70_2,q70_3,q70_4;
		int q701index_selected = ((RadioGroup)v.findViewById(R.id.radioGroup70s1)).indexOfChild(((RadioGroup)v.findViewById(R.id.radioGroup70s1))
                .findViewById(((RadioGroup)v.findViewById(R.id.radioGroup70s1)).getCheckedRadioButtonId()))+1;
		
		
		q70_1 = String.valueOf(q701index_selected);
		

		int q702index_selected = ((RadioGroup)v.findViewById(R.id.radioGroup70s2)).indexOfChild(((RadioGroup)v.findViewById(R.id.radioGroup70s2))
                .findViewById(((RadioGroup)v.findViewById(R.id.radioGroup70s2)).getCheckedRadioButtonId()))+1;
		
		
		q70_2 = String.valueOf(q702index_selected);
		
		int q703index_selected = ((RadioGroup)v.findViewById(R.id.radioGroup70s3)).indexOfChild(((RadioGroup)v.findViewById(R.id.radioGroup70s3))
                .findViewById(((RadioGroup)v.findViewById(R.id.radioGroup70s3)).getCheckedRadioButtonId()))+1;
		
		
		q70_3 = String.valueOf(q703index_selected);
		
		int q704index_selected = ((RadioGroup)v.findViewById(R.id.radioGroup70s4)).indexOfChild(((RadioGroup)v.findViewById(R.id.radioGroup70s4))
                .findViewById(((RadioGroup)v.findViewById(R.id.radioGroup70s4)).getCheckedRadioButtonId()))+1;
		
		
		q70_4 = String.valueOf(q704index_selected);
		
		
		
			String sql = "";
			
				 sql = String.format("UPDATE %s SET q70_1='%s', q70_2='%s',q70_3='%s'," +
						"q70_4='%s' WHERE dataid = '%s' AND memid = '%s'", CommonStaticClass.questionMap.get(
								CommonStaticClass.currentSLNo).getTablename(),q70_1,q70_2,q70_3,q70_4, CommonStaticClass.dataId, CommonStaticClass.memberID );
	...
	public int getFormIndex(String formname) {
		...
		if (formname.equalsIgnoreCase("frmtimes")) {
			index = 27;
		}
		if (formname.equalsIgnoreCase("frmsamplegrid")) {
			index = 28;
		}
	...
	public void gotoForm(String formname) {
		...
		case 27:
			loadGuiFrmtimes(frmtimes);
			break;

		case 28:
			loadGuiFrmSample(frmsamplegrid);
			break;
	...
	private void loadGuiFrmSample(final ViewGroup v) {
		...
		((TextView)v.findViewById(R.id.q67_1)).setText(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z01");
		
		((TextView)v.findViewById(R.id.q67_2)).setText(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z02");
		
		((TextView)v.findViewById(R.id.q67_3)).setText(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z03");
		
		((TextView)v.findViewById(R.id.q67_4)).setText(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Y01");
		
		
		
		
		((TextView)v.findViewById(R.id.q68_1)).setText(this.getRandomId(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z01"));
		
		((TextView)v.findViewById(R.id.q68_2)).setText(this.getRandomId(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z02"));
		
		((TextView)v.findViewById(R.id.q68_3)).setText(this.getRandomId(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Z03"));
		
		((TextView)v.findViewById(R.id.q68_4)).setText(this.getRandomId(CommonStaticClass.dataId + "E"
				+ CommonStaticClass.memberID + "Y01"));
		...
		String sql = "Select * from sample where dataid='" + CommonStaticClass.dataId
					+ "' and memid=" + CommonStaticClass.memberID;
			...
			if (mCursor1.getCount() > 0) 
			{
				if (mCursor1.moveToFirst()) {
					do {
						...
						String q70_1 = mCursor1.getString(mCursor1.getColumnIndex("q70_1"));
						String q70_2 = mCursor1.getString(mCursor1.getColumnIndex("q70_2"));
						String q70_3 = mCursor1.getString(mCursor1.getColumnIndex("q70_3"));
						String q70_4 = mCursor1.getString(mCursor1.getColumnIndex("q70_4"));
							
						if(q70_1!=null){
						if(q70_1.equalsIgnoreCase("1"))	
						{
							/*RadioGroup rd1 = ((RadioGroup)v.findViewById(R.id.radioGroup70s1));
							((RadioButton)rd1.findViewById(R.id.radio0)).setSelected(true);*/
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s1)).findViewById(R.id.radio0)).setChecked(true);
														
						}


						if(q70_1.equalsIgnoreCase("2"))	
						{
							/*RadioGroup rd1 = ((RadioGroup)v.findViewById(R.id.radioGroup70s1));
							((RadioButton)rd1.findViewById(R.id.radio0)).setSelected(true);*/
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s1)).findViewById(R.id.radio1)).setChecked(true);
														
						}
						

						if(q70_1.equalsIgnoreCase("3"))	
						{
							/*RadioGroup rd1 = ((RadioGroup)v.findViewById(R.id.radioGroup70s1));
							((RadioButton)rd1.findViewById(R.id.radio0)).setSelected(true);*/
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s1)).findViewById(R.id.radio2)).setChecked(true);
						...
						if(q70_2.equalsIgnoreCase("1"))	
						{
													
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s2)).findViewById(R.id.radio0)).setChecked(true);
														
						}


						if(q70_2.equalsIgnoreCase("2"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s2)).findViewById(R.id.radio1)).setChecked(true);
														
						}
						

						if(q70_2.equalsIgnoreCase("3"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s2)).findViewById(R.id.radio2)).setChecked(true);
														
						}
						}
						if(q70_3!=null)
						{
						if(q70_3.equalsIgnoreCase("1"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s3)).findViewById(R.id.radio0)).setChecked(true);
														
						}


						if(q70_3.equalsIgnoreCase("2"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s3)).findViewById(R.id.radio1)).setChecked(true);
														
						}
						

						if(q70_3.equalsIgnoreCase("3"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s3)).findViewById(R.id.radio2)).setChecked(true);
						...
						if(q70_4!=null)
						{
						if(q70_4.equalsIgnoreCase("1"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s4)).findViewById(R.id.radio0)).setChecked(true);
														
						}


						if(q70_4.equalsIgnoreCase("2"))	
						{
							
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s4)).findViewById(R.id.radio1)).setChecked(true);
														
						}
						

						if(q70_4.equalsIgnoreCase("3"))	
						{
							((RadioButton)((RadioGroup)v.findViewById(R.id.radioGroup70s4)).findViewById(R.id.radio2)).setChecked(true);
		...
		saveNxtButton = (Button) v.findViewById(R.id.btnSaveObservationH2);

		saveNxtButton.setOnClickListener(new View.OnClickListener() {

			public void onClick(View vg) {
				// TODO Auto-generated method stub
				updateTableDataFrmSample(v);
			}
