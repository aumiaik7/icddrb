...
public class CustomCursorAdapter extends CursorAdapter {
	...
	public void bindView(View convertView, Context context, Cursor cursor) {
		...
		String Phone = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(23)));
		String Vill = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(24)));
		String UPZ = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(25)));
		String Dist = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(26)));

		String WT = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(27)));
		String HT = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(28)));
		String MUAC = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(29)));

		String DS17 = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(30)));
		String DS18D = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(31)));
		String DS18H = cursor.getString(cursor.getColumnIndex(cursor
				.getColumnName(32)));
