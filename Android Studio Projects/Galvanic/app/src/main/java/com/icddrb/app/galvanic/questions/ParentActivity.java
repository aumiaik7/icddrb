package com.icddrb.app.galvanic.questions;
...
import com.icddrb.app.galvanic.BaseActivity;
import com.icddrb.app.galvanic.CommonStaticClass;
import com.icddrb.app.galvanic.Options;
import com.icddrb.app.galvanic.R;
import com.icddrb.app.galvanic.adapters.SpinAdapter;
...
/*	private void FillAllDataidCombo(final ViewGroup v) {
	...
	private void updateTableDataFrmHHID() {
		...
		try {
			...
			if (Selectcursor.getCount() != 0) {
				...
				String sqlupdate = "Insert into tblMainQues (dataid,EntryBy, EntryDate, EntryTime, AssetId,VersionNo) values('"
						+ CommonStaticClass.dataId
						+ "','"
						+ CommonStaticClass.userSpecificId
						+ "','"
	...
	private boolean IsValidClusterID(String ClusterID) {
		String id = "";
		String sql = "Select * from frmrtblSamplesInfo where clusterid='"
