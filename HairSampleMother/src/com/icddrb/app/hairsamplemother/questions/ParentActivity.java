package com.icddrb.app.hairsamplemother.questions;
...
import com.icddrb.app.hairsamplemother.BaseActivity;
import com.icddrb.app.hairsamplemother.CommonStaticClass;
import com.icddrb.app.hairsamplemother.Options;
import com.icddrb.app.hairsamplemother.R;
import com.icddrb.app.hairsamplemother.adapters.SpinAdapter;
import com.icddrb.app.hairsamplemother.db.DatabaseHelper;
...
//	}
	...
	private void updateTableDataFrmNumeric() {
		...
		if (qAns.length() > 0)
		{
		    if(qName.equalsIgnoreCase("q10") && qAns.length() !=4)
			{
...
//						}
//					}
					if(qName.equalsIgnoreCase("q12") && code !=5  && getChoiceValue("q11") == 3)
					{
						CommonStaticClass.findOutNextSLNo(qName, "END");
						CommonStaticClass.nextQuestion(ParentActivity.this);
					}
	...
	private void updateTableDataFrmText() {
		...
		if (qAns.length() > 0) {
			...
			if (dbHelper.executeDMLQuery(sql)) {
				...
				else if(qName.equalsIgnoreCase("q12Other") && getChoiceValue("q11") == 3)
				{
					CommonStaticClass.findOutNextSLNo(qName, "END");
					CommonStaticClass.nextQuestion(ParentActivity.this);
				}
