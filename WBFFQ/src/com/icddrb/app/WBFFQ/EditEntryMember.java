...
//				Log.e("item","clicked");
				...
				//CommonStaticClass.participantType = CommonStaticClass.dataId.substring(0, 1);
	...
	private void loadDataToList(){
		String sql = "Select memberid from tblMainQues Where dataid='"+CommonStaticClass.dataId+"'";
		Cursor mCursor = null;
		try{
			...
			if(mCursor.moveToFirst()){
				do{
					dID.add(mCursor.getString((mCursor.getColumnIndex("memberid"))));
	...
	private void AddSkipForMembers()
	{
	    ...
	    //SKIP ADDITION
		String sql1="";
		sql1 = "Select * from tblFamilyMember where dataid='"+CommonStaticClass.dataId+"' and memberid="+CommonStaticClass.memberID;
		...
		try{			
			...
			if(mCursor1.moveToFirst()){
				do{
					...
					String a = mCursor1.getString(mCursor1.getColumnIndex(column1))+"";
					String b = mCursor1.getString(mCursor1.getColumnIndex(column2))+"";
					String c = mCursor1.getString(mCursor1.getColumnIndex(column3))+"";
	...
	private void loadQuestions() {
		...
		String sql = "Select * from tblQuestion where SLNO>=31";
		Cursor mCursor = null;
		try{			
			mCursor = dbHelper.getQueryCursor(sql);
			if(mCursor.moveToFirst()){
			...
			String sqlForSec = "Select SLNo,Qvar from tblQuestion where  SLNO>=31 and Qvar  like 'sec%' order by SLNo";
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case ALLQUESTIONLOADED:
				...
				CommonStaticClass.isChecked = false;
				Intent i = new Intent(EditEntryMember.this, QListScreenForEdit.class);
				startActivity(i);
				break;
